import svgPaths from "./svg-86mafasu90";
...
export default function Frame1() {
  ...
  return (
    <div 
      className="bg-gradient-to-r content-stretch flex from-[20.4%] from-[rgba(240,91,81,0.34)] items-center pl-[16px] py-[8px] relative rounded-[70px] size-full to-[rgba(247,247,247,0)] cursor-pointer"
